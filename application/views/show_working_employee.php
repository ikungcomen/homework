                ...
                <table class="table table-hover">
                    <thead>
                      <tr style="background-color: #585858;">
                          ...
                          <th class="text-center"><font color="#FFFFFF">จำนวนวันทำงาน</font></th>
                          <th class="text-center"><font color="#FFFFFF">จำนวนเงินค่าจ้าง</font></th>
                          <th class="text-center"><font color="#FFFFFF">ทำงานวันที่</font></th>
                      </tr>
                    </thead>
                    <tbody>
                    <?php 
                      ...
                      <tr>
                        ...
                        <td class="text-center"><?php echo $row['all_workingday']; ?></td>
                        <td class="text-center"><?php echo $row['all_mont']; ?></td>
